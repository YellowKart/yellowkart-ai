...
public class ProductSuggestion {
    ...
    public ProductSuggestion(Long id, String name, String description, BigDecimal price,
                             String category, String imageUrl, Integer stock, Double rating,
                             double confidence, String reason, List<String> matchedKeywords) {
        this(id, name, description, price, category, null, imageUrl, stock, rating, confidence, reason, matchedKeywords);
    }

    public ProductSuggestion(Long id, String name, String description, BigDecimal price,
                             String category, String brand, String imageUrl, Integer stock, Double rating,
                             double confidence, String reason, List<String> matchedKeywords) {
        this.id = id;
        this.name = name;
